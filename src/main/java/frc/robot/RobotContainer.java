...
public class RobotContainer {
  ...
  public static final ShooterTest shooter = new ShooterTest();
  ...
  public RobotContainer() {
    ...
    shooter.setDefaultCommand(new ShooterTestCmd(shooter, controleXbox));
  ...
  private void configureBindings() {
    ...
    // new JoystickButton(controleXbox, XboxController.Button.kB.value).whileTrue(Commands.startEnd(
    //   () -> gSubsystem.descerGarra(), 
    //   () -> gSubsystem.pararGarra(),
    //   gSubsystem));

    new POVButton(controleXbox, 180).onTrue(Commands.runOnce(
      ()-> shooter.motor(), 
